...
import AlternateNameForm from "@/app/(authenticated)/(main)/home/_components/create-cohort/1-alternate-name-form";
import SlugForm from "@/app/(authenticated)/(main)/home/_components/create-cohort/2-slug";
import PrimaryCategoryForm from "@/app/(authenticated)/(main)/home/_components/create-cohort/3-primary-category";
import DescriptionForm from "@/app/(authenticated)/(main)/home/_components/create-cohort/4-description";
import FinalizeForm from "@/app/(authenticated)/(main)/home/_components/create-cohort/5-finalize";
